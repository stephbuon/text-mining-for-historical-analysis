...
To illustrate how an API works, consider this example from the New York City Open Data portal, "NYC OpenData", which provides access to vast public datasets including population data, budgetary data, and data on city infrastructure. For this exercise we will look at just current and historic 311 service requests. The link below takes us to a webpage for the dataset _311 Call Center Inquiry_, which also provides a direct link to the API endpoint.
