...
When installing code or data from a repository such as GitHub, we can use the `install_github()` function. For example, the `hansardr` package can be installed directly from its GitHub repository, as shown below.
