...
Previously, we demonstrated techniques were we worked with chunks of the data at a time to save computer memory. We did this so the code will run on a laptop. 
